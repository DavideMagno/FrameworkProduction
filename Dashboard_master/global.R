...
source("/home/threshold/FrameworkProduction/Scripts/Portfolios.R")
source("/home/threshold/FrameworkProduction/Scripts/myDatepickerInput.R")
source("/home/threshold/FrameworkProduction/Scripts/RelativeTrade.R")
source("/home/threshold/FrameworkProduction/Scripts/Hedging.R")
source("/home/threshold/FrameworkProduction/Scripts/FrameworkFunctions.R")
source("/home/threshold/FrameworkProduction/Scripts/xts_graphs.R")
source("/home/threshold/FrameworkProduction/Scripts/PairsTrading.R")


base_dir <- "/home/threshold/FrameworkData"

options(shiny.reactlog = TRUE)
# thematic::thematic_shiny(font = "auto")

asset_manager_choices <- c(
  "Base Universe" = "_new5",
  "Futures" = "_futures",
  "Rolled Futures" = "_futures_new_PERP",
  "ETF" = "_etf",
  "XCCY" = "_ccy",
  "XCCY 1Y" = "_ccy1y",
  "Base Universe + XCCY" = "_ccyexp"
)

time_limit_choices <- c(
  "None" = 252,
  "5 days" = 5,
  "6 days" = 6,
  "7 days" = 7,
...
CalculateType <- function(prices, FrameworkIndices = NULL, dropdown_am = "") {
  
  if (is.null(FrameworkIndices)) {
...
CalculateTradable <- function(prices, FrameworkIndices = NULL, dropdown_am = "") {
  if (is.null(FrameworkIndices)) {
    load(glue::glue("/home/threshold/FrameworkData/Data/IndexMapping{dropdown_am}.RData"))
  }
