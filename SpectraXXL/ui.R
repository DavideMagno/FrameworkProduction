...
page_sidebar(
  theme = bs_theme(bootswatch = "superhero",
                   font_scale = 0.9,
                   version = 5),
  title = "SpectraFX Framework Dashboard - provided by Hedge Analytics Ltd",
  sidebar = sidebar(width = "300px",
                    ...
                    conditionalPanel(
                      ...
                      actionButton("relative_value_button", 
                                   "Update the page",
                                   style = "margin-top:15px; margin-bottom:15px; width:251px"),
    ...
    navset_tab(
      ...
      nav_panel(
        ...
        card(
          ...
          height = "550px",
          card_body(
            column(12, reactable::reactableOutput("landing_table"),
                   style = "height:500px;"))
        ...
        card(
          ...
          highcharter::highchartOutput("index_and_eigendata", height = "1100px")
      ...
      nav_panel(
        ...
        div(id='bigbox',
            fluidRow(
              column(2, offset = 1, align = "center", uiOutput('relative.value.asset.ccy')),
              column(2,align = "center", uiOutput('relative.value.asset.type')),
              column(2,align = "center", uiOutput('relative.value.asset.maturity')),
              column(3,align = "center", switchInput(
                inputId = "remove_trades",
                label = "Show the trades", 
                labelWidth = "250px",
                width = "250px"
              )),
